...
export default function Home() {
  ...
  return (
    <div className="home-page">
      ...
      <section className="stats-section fade-up"><BotanicalField tone="paper" variant="tree" /><div className="container stats-inner"><span className="eyebrow">The people behind your food</span><h2>Meet the people behind your food</h2><p>We empower communities to bring you the best.</p><div className="stats-grid">{[['500+', 'Farmers'], ['15+', 'Regions'], ['20+', 'Products'], ['1000+', 'Quality Checks']].map(([value, label]) => <div key={label}><strong>{value}</strong><span>{label}</span></div>)}</div></div></section>
